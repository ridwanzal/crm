            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li class="active"><a href="<?php echo base_url();?>admin/daftar_pelanggan"><i class="notika-icon notika-support"></i> Pelanggan</a>
                        </li>
                    ...
                    <div class="modal-dialog modals-default">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-default" data-dismiss="modal" class="close_modal">Close</button>
                            </div>
                            <br/>
                        </div>
                    </div>
