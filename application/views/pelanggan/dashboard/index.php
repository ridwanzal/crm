                    ...
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <?php
                            if($this->session->userdata('status') == "login"){ ?>
                                <li><a><i class="notika-icon notika-mail"></i> Transaksi</a>
                                </li>
                                <li><a><i class="notika-icon notika-edit"></i> Kritik & Saran</a>
                                </li>
                            <?php }
                        ?>
                    </ul>
                    <div class="tab-content custom-menu-content">
                        <div id="Home" class="tab-pane in active notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                <li><a href="index.html">Ayam 0 - 1 (kg)</a>
                                </li>
                                <li><a href="index.html">Ayam 1 - 2 (kg)</a>
                                </li>
                                <li><a href="index.html">Ayam 2 - 3 (kg)</a>
                                </li>
                                <li><a href="index.html">Ayam 3 - 4 (kg)</a>
                                </li>
                            </ul>
                        </div>
                    </div>
